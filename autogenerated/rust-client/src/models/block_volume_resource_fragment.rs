...
pub struct BlockVolumeResourceFragment {
    ...
    #[serde(rename = "os-vol-host-attr:host", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "dedicated_storage_id", skip_serializing_if = "Option::is_none")]
    pub dedicated_storage_id: Option<String>,
    #[serde(rename = "dedicated_storage_name", skip_serializing_if = "Option::is_none")]
